...
% My goal
The purpose of this dissertation is to automate the process, not
just to save time, but so that wedding planners can rest easy
knowing that the seating plan is (among) the best possible for
the guest list.
